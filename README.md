...
git clone https://github.com/<your-username>/cucas-fu-scholarship.git
cd cucas-fu-scholarship
...
# Run the ETL / data preprocessing notebooks under /ml
# Load SQL scripts under /sql into your SQL Server instance (Bronze → Silver → Gold)
# Open the Power BI report under /powerbi to explore the dashboards
```
